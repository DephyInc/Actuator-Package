 ...
 *
 * Created on: 2020-06-23 15:28:48.823199
 * Author: Dephy, Inc.
 *
 */
...
#define CELLSCREENER_SYSTEM_TIME_POS 14
#define CELLSCREENER_STRUCT_DEVICE_FIELD_COUNT 15
#define CELLSCREENER_LABEL_MAX_CHAR_LENGTH 13

//This is The Device fields*10 + deviceField+1. Ten is the max string length of 2^32 in decimal separated from commas
#define CELLSCREENER_DATA_STRING_LENGTH 166
...
struct CellScreenerState
{
	...
	//the system time
	int systemTime;
	uint32_t deviceData[CELLSCREENER_STRUCT_DEVICE_FIELD_COUNT];
};
