 ...
 *
 * Created on: 2020-07-30 00:34:59.001345
 * Author: Dephy, Inc.
 *
 */
...
#define NEWBOO_SYSTEM_TIME_POS 35
#define NEWBOO_STRUCT_DEVICE_FIELD_COUNT 36
#define NEWBOO_LABEL_MAX_CHAR_LENGTH 17

//This is The Device fields*10 + deviceField+1. Ten is the max string length of 2^32 in decimal separated from commas
#define NEWBOO_DATA_STRING_LENGTH 397
...
struct NewBooState
{
	...
	//the system time
	int systemTime;
	uint32_t deviceData[NEWBOO_STRUCT_DEVICE_FIELD_COUNT];
};
