...
#define NEWBOO_SYSTEM_TIME_POS 60
#define NEWBOO_STRUCT_DEVICE_FIELD_COUNT 61
...
#define NEWBOO_DATA_STRING_LENGTH 672
...
///
void NewBooSetData(struct NewBooState *newboo, const uint32_t _deviceStateBuffer[], int systemStartTime);
...
///
/// \param newboo the data to be converted to an array
///
/// \param newbooDataArray the array in which to place the data
///
...
///
/// \param newboo the data to access
///
