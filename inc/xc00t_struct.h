#ifndef XC00T_STRUCT_H
#define XC00T_STRUCT_H
...
#define XC00T_SYSTEM_TIME_POS 60
#define XC00T_STRUCT_DEVICE_FIELD_COUNT 61
#define XC00T_LABEL_MAX_CHAR_LENGTH 19

/// This is The Device fields * 10 + deviceField + 1. Ten is the max string length of 2^32 in
/// decimal separated from commas
#define XC00T_DATA_STRING_LENGTH 672
...
///
/// \param XC00t is the struct with the data to be set
///
...
///
void XC00tSetData(struct XC00tState *xc00t, const uint32_t _deviceStateBuffer[], int systemStartTime);

///
/// \brief takes all data and places it into single, comma separated string
///
/// \param XC00t is the struct with the data to be placed in the string
///
/// \param dataString is where the new string wll be placed
///
void XC00tDataToString(struct XC00tState *xc00t, char dataString[XC00T_DATA_STRING_LENGTH]);
...
///
void XC00tGetLabels(char labels[XC00T_STRUCT_DEVICE_FIELD_COUNT][XC00T_LABEL_MAX_CHAR_LENGTH]);
...
/// \param labels is the array of labels containing the parameter names
///
int XC00tGetLabelsForLog(char labels[XC00T_STRUCT_DEVICE_FIELD_COUNT][XC00T_LABEL_MAX_CHAR_LENGTH]);

///
/// \brief Places data from struct into an array.
///
/// \param xc00t the data to be converted to an array
///
/// \param xc00tDataArray the array in which to place the data
///
void XC00tStructToDataArray(struct XC00tState xc00t, int32_t xc00tDataArray[XC00T_STRUCT_DEVICE_FIELD_COUNT]);

///
/// \brief Get data based on data position from device communication.
///
/// \param xc00t the data to access
///
/// \param dataPosition the position of data to access
///
/// \param dataValid return false if requested data position is invalid
///
int GetXC00tDataByDataPosition( struct XC00tState xc00t, int dataPosition);

#ifdef __cplusplus
} //extern "C"
#endif

#endif //XC00T_STRUCT_H
