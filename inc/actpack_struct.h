...
///
void ActPackSetData(struct ActPackState *actpack, const uint32_t _deviceStateBuffer[], int systemStartTime);
...
///
/// \param actpack the data to be converted to an array
///
