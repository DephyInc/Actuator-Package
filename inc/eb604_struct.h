...
#define EB604_SYSTEM_TIME_POS 60
#define EB604_STRUCT_DEVICE_FIELD_COUNT 61
...
#define EB604_DATA_STRING_LENGTH 672
...
///
void EB604SetData(struct EB604State *eb604, const uint32_t _deviceStateBuffer[], int systemStartTime);
...
///
/// \param eb604 the data to be converted to an array
///
/// \param eb604DataArray the array in which to place the data
///
...
///
/// \param eb604 the data to access
///
