 ...
 *
 *
 *  Created on: 2020-04-29 14:39:30.340588
 *      Author: Dephy Inc
 */
...
///
void HabsoluteSetData (struct HabsoluteState *habsolute, uint32_t _deviceStateBuffer[], clock_t systemStartTime);
