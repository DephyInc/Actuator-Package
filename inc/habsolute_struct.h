 ...
 *
 *
 *  Created on: 2020-04-11 09:06:31.714799
 *      Author: Dephy Inc
 */
...
struct HabsoluteState 
 { 
	...
	void sendToStream(std::stringstream &ss) 
 	...
 	{
		std::string labels[HABSOLUTE_STRUCT_DEVICE_FIELD_COUNT];
		GetLabels(labels);
		std::string outputString;
		for(int index=HABSOLUTE_STATE_TIME_POS;index<HABSOLUTE_STRUCT_DEVICE_FIELD_COUNT;index++)
		{
