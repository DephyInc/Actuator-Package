...
#define EXO_SYSTEM_TIME_POS 59
#define EXO_STRUCT_DEVICE_FIELD_COUNT 60
...
#define EXO_DATA_STRING_LENGTH 661
...
///
/// \param exo the data to be converte to an array
///
/// \param exoDataArray the array in which to place the data
///
