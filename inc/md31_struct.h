#ifndef MD31_STRUCT_H
#define MD31_STRUCT_H
...
#define MD31_SYSTEM_TIME_POS 55
#define MD31_STRUCT_DEVICE_FIELD_COUNT 56
#define MD31_LABEL_MAX_CHAR_LENGTH 19

/// This is The Device fields * 10 + deviceField + 1. Ten is the max string length of 2^32 in
/// decimal separated from commas
#define MD31_DATA_STRING_LENGTH 617
...
///
/// \param MD31 is the struct with the data to be set
///
...
///
void MD31SetData(struct MD31State *md31, const uint32_t _deviceStateBuffer[], int systemStartTime);

///
/// \brief takes all data and places it into single, comma separated string
///
/// \param MD31 is the struct with the data to be placed in the string
///
/// \param dataString is where the new string wll be placed
///
void MD31DataToString(struct MD31State *md31, char dataString[MD31_DATA_STRING_LENGTH]);
...
///
void MD31GetLabels(char labels[MD31_STRUCT_DEVICE_FIELD_COUNT][MD31_LABEL_MAX_CHAR_LENGTH]);
...
/// \param labels is the array of labels containing the parameter names
///
int MD31GetLabelsForLog(char labels[MD31_STRUCT_DEVICE_FIELD_COUNT][MD31_LABEL_MAX_CHAR_LENGTH]);

///
/// \brief Places data from struct into an array.
///
/// \param md31 the data to be converted to an array
///
/// \param md31DataArray the array in which to place the data
///
void MD31StructToDataArray(struct MD31State md31, int32_t md31DataArray[MD31_STRUCT_DEVICE_FIELD_COUNT]);

///
/// \brief Get data based on data position from device communication.
///
/// \param md31 the data to access
///
/// \param dataPosition the position of data to access
///
/// \param dataValid return false if requested data position is invalid
///
int GetMD31DataByDataPosition( struct MD31State md31, int dataPosition);
