...
#define EB60_SYSTEM_TIME_POS 60
#define EB60_STRUCT_DEVICE_FIELD_COUNT 61
...
#define EB60_DATA_STRING_LENGTH 672
...
///
void EB60SetData(struct EB60State *eb60, const uint32_t _deviceStateBuffer[], int systemStartTime);
...
///
/// \param eb60 the data to be converted to an array
///
/// \param eb60DataArray the array in which to place the data
///
