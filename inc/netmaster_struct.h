 ...
 *
 *
 *  Created on: 2020-04-29 14:39:31.441460
 *      Author: Dephy Inc
 */
...
///
void NetMasterSetData (struct NetMasterState *netmaster, uint32_t _deviceStateBuffer[], clock_t systemStartTime);
