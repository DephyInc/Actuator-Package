...
class FlexSEA:
    ...
    def read_bms_device_all(self, dev_id, data_size):
        ...
        items_read = self.c_lib.fxReadBMSDeviceAll(
            dev_id, c.byref(data), data_size)
        if items_read == -1:
