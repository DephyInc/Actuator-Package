...
def fxHighStressTest(port0, baudRate, port1='', commandFreq=1000,
	...
	plot_data(devices, positionAmplitude, positionFreq, currentAmplitude,
			  currentFreq, commandFreq)


def plot_data(devices, pos_amp, pos_freq, curr_amp, curr_freq, cmd_freq,
			  type_str='sine wave'):
	"""
	Plots received data
	...
	for dev in devices:
		# Current Plot:
		figure_ind = plotSetpointVsDesired(dev['id'], figure_ind,
										   fx.hssCurrent, curr_amp, curr_freq,
										   type_str, cmd_freq, TIMESTAMPS,
										   dev['curr_requests'],
										   dev['curr_measurements'],
										   CYCLE_STOP_TIMES)

		figure_ind = plotSetpointVsDesired(dev['id'], figure_ind,
										   fx.hssPosition, pos_amp, pos_freq,
										   type_str, cmd_freq, TIMESTAMPS,
										   dev['pos_requests'],
